...
class Wpfhubspot_Admin_Forms extends Wpfhubspot_Admin {
  ...
  */
  // Te llamamos gratis:        832d7a8a-415c-4c7b-a3cf-c01edcdc4967
  // Datos usuario funerarias:  482e3e8e-3001-477a-aa47-aab334f837b8
  public function wpfhubspotSendForm( $params ){
    $this->custom_logs( $this->dumpPOST($userIP .'==========' ) );
    $this->custom_logs( $this->dumpPOST($userIP .' - wpfhubspotSendForm' ) );
